...
function Home() {
  ...
  return (
    <div className="home-div">
        ...
        <br></br>
        <button onClick={()=>{navigate('/Reports')}} className='report-btn'>See Your Reports</button>
        <br></br>
        <br></br>
        <div className="org-brief">
            ...
            and concerns through us to their organization's HR department, ensuring anonymity throughout the process.
            </p>
            <br></br>
